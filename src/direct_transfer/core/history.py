...
class TransferRecord:
    ...
    def __post_init__(self) -> None:
        object.__setattr__(self, "resumed", bool(self.resumed))
                ...
                connection.execute(
                    ...
                    ON CONFLICT(transfer_id) DO UPDATE SET
                        ...
                        error=CASE
                            ...
                            ELSE excluded.error
                        END,
                        resumed=MAX(transfers.resumed, excluded.resumed),
                        resume_offset=MAX(transfers.resume_offset, excluded.resume_offset)
                    """,
    ...
    def _migrate(self) -> None:
        with self._lock, self._connection() as connection:
            ...
            if version < 2:
                connection.executescript(
                    """
                    ALTER TABLE transfers ADD COLUMN resumed INTEGER NOT NULL DEFAULT 0;
