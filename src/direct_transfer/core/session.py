...
from direct_transfer.utils.crypto import pack_frame, unpack_frame

PROTOCOL_VERSION = 3
MAX_HANDSHAKE_SIZE = 8192
NONCE_BYTES = 32
_DOMAIN = b"direct-transfer-v3-authenticated-handshake\x00"
