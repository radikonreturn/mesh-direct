"""Persistent Ed25519 device identity for Direct Transfer installations."""
...
def default_app_dir() -> Path:
    """Return the cross-platform per-user Direct Transfer config directory."""
    return user_config_path("direct-transfer", appauthor=False) / "identity"
